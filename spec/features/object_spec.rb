...
describe 'objects' do
  ...
  before(:each) do
    ...
    inv_collection_1 = create(:private_collection, name: 'Collection 1', mnemonic: 'collection_1')
  ...
  describe 'in public collection' do
    before(:each) do
      inv_collection_1 = create(:inv_collection, name: 'Public Collection 1', mnemonic: 'public_collection_1')
      @collection_1_id = mock_ldap_for_collection(inv_collection_1)

      @obj = create(:inv_object, erc_who: 'Doe, Jane', erc_what: 'Public Object 1', erc_when: '2018-01-01')
      inv_collection_1.inv_objects << obj
    end
  ...
  describe 'in public collection w/restricted downloads' do
    before(:each) do
      inv_collection_1 = create(:download_restricted_collection, name: 'Download Restricted Collection 1', mnemonic: 'dr_collection_1')
      @collection_1_id = mock_ldap_for_collection(inv_collection_1)
    ...
    it 'displays a download button with download permission' do
      mock_permissions_all(user_id, collection_1_id)
